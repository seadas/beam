 ...
 */
public class WebHelpSeaDASForumFAQAction extends ExecCommand {
    ...
    public void actionPerformed(CommandEvent event) {
        ...
        try {
            ...
            desktop.browse(URI.create("https://oceancolor.gsfc.nasa.gov/forum/oceancolor/board_show.pl?bid=29"));
        } catch (IOException e) {
            // TODO - handle
