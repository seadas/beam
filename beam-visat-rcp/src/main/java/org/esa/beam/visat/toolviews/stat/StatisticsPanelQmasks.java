 ...
 */
class StatisticsPanelQmasks extends PagePanel implements MultipleRoiComputePanelQmasks.ComputeMasks, StatisticsDataProvider {
    ...
    private MultipleRoiComputePanelQmasks computePanel;
    ...
    private final StatisticsPanelQmasks.PopupHandler popupHandler;
    ...
    public StatisticsPanelQmasks(final ToolView parentDialog, String helpID) {
...
//        GridBagUtils.addToPanel(leftPanel, spreadsheetScrollPane, gbcLeftPanel, "fill=BOTH, weightx=1.0, weighty=0.0, anchor=NORTHWEST, gridy=1,insets.top=5");
    ...
    private JPanel getRightPanel() {
        ...
        computePanel = new MultipleRoiComputePanelQmasks(this, getRaster());
...
//                    //       exportButton.setEnabled(exportButtonEnabled);
    ...
    private int getMasksToProcessCount(Mask[] selectedMasks, boolean includeNull, MultipleRoiComputePanelQmasks.MaskGrouping maskGrouping) {
        ...
        if (selectedMasks != null && selectedMasks.length > 0) {
            ...
            if (maskGrouping == MultipleRoiComputePanelQmasks.MaskGrouping.NONE) {
    ...
    // includes null mask if requested
    private Mask[] getMasksToProcess(Mask[] selectedMasks, String maskName, boolean includeNull, MultipleRoiComputePanelQmasks.MaskGrouping maskGrouping) {
    ...
    private Mask getLogicallyCombinedMask(Mask[] selectedMasks, String maskName, MultipleRoiComputePanelQmasks.MaskGrouping maskGrouping) {
