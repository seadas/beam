 ...
 */
class StatisticsSpreadsheetPagePanelQmasks extends PagePanel {

    private static final String TITLE_PREFIX = "Statistics Spreadsheet";

    private final StatisticsSpreadsheetPagePanelQmasks.PopupHandler popupHandler;
    ...
    private StatisticsPanelQmasks statisticsPanel;


    public StatisticsSpreadsheetPagePanelQmasks(final ToolView parentDialog, String helpID, StatisticsCriteriaPanel statisticsCriteriaPanel, Object[][] statsSpreadsheet, StatisticsPanelQmasks statisticsPanel) {
...
//        setMinimumSize(new Dimension(1000, 390));
        ...
        popupHandler = new StatisticsSpreadsheetPagePanelQmasks.PopupHandler();
//        if (visatApp != null) {
